...
<div class="col-sm-6">
	...
	<label class="formName" for="userName"><i class="fa fa-user"></i></label>
	...
	<div class="form-custom">
	<label class="formEmail" for="commentEmail"><i class="fa fa-envelope"></i></label>
	...
	<div class="form-custom">
	<label class="formUrl" for="commentURL"><i class="fa fa-link"></i></label>
...
<textarea rows="20" cols="10" class="inputbox" onblur="if(this.value=='') this.value='<?php echo JText::_('K2_ENTER_YOUR_MESSAGE_HERE'); ?>';" onfocus="if(this.value=='<?php echo JText::_('K2_ENTER_YOUR_MESSAGE_HERE'); ?>') this.value='';" name="commentText" id="commentText"><?php echo JText::_('K2_ENTER_YOUR_MESSAGE_HERE'); ?></textarea>
	...
	<input type="submit" class="button" id="submitButton" value="<?php echo JText::_('K2_SUBMIT_COMMENT'); ?>"/>
