		...
		<div class="itemNaviTop">
			<dl class="article-info">
				...
				<dd>
					...
					<span><?php echo JText::_('K2_AUTHOR_TEMPLATE').' '; ?></span>
			...
			<dd>
				...
				<?php else: ?>
					...
					<?php echo JText::_('- '); ?> <i class="fa fa-comments-o"></i>
...
<?php if($this->item->params->get('itemHits') || ($this->item->params->get('itemDateModified') && intval($this->item->modified)!=0)): ?>
	...
	<?php endif; ?>
	    ...
	    <?php endif; ?>
<div class="clr"></div>
<?php if($this->item->params->get('itemTwitterButton',1) || $this->item->params->get('itemFacebookButton',1) || $this->item->params->get('itemGooglePlusOneButton',1) || $this->item->params->get('itemPrintButton') || $this->item->params->get('itemEmailButton')): ?>
<div class="itemSocialCustom">
<div class="shareText"><?php echo JText::_('K2_SHARE_THIS_ARTICLE'); ?></div>
	...
	<div class="itemSocialSharing">
		...
		<div class="itemFacebookButton">
			...
			<div class="fb-like" data-layout="button_count" data-send="false" data-width="100" data-show-faces="true" data-share="false"></div>
	...
	<?php endif; ?>
<div class="plgSocial"><a href="<?php echo $this->item->link; ?>"></a></div>

		<?php if( $this->item->params->get('itemPrintButton') || $this->item->params->get('itemEmailButton')
				 ): ?>
...
<!-- end itemSocialCustom -->
   ...
   <?php if($this->item->params->get('itemAuthorBlock') && empty($this->item->created_by_alias)): ?>
	   ...
	   <div class="itemAuthorBlock block">
			<h3 class="aboutAuthor"><?php echo JText::_('K2_ABOUT_AUTHOR'); ?></h3>
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
	    	...
	    	<span class="commentLink">
		    	...
		    	<?php echo JHTML::_('date', $comment->commentDate, JText::_('DATE_FORMAT_TEMPLATE2')); ?>
		    </span>
