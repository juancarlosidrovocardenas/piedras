				...
				<dd class="CommentsLink">
					...
					<div class="catItemCommentsLink">
						...
						<?php else: ?>
							...
							<?php echo JText::_('- '); ?> <i class="fa fa-comments-o"></i><a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
								<?php echo $this->item->numOfComments; ?> <?php echo ($this->item->numOfComments>1); ?>
							</a>
							<?php else: ?>
								<?php echo JText::_('- '); ?> <a href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
