...
if ($nb_items>0){
	...
	if ((int)$params->get('pager_display', 1)){
		...
		<div class="pager-container">
			<ul class="pages">
				<li><div class="page page-previous" href="#<?php echo $item_container; ?>" data-jslide="prev">&laquo; </div></li>
			<?php for ($j=0; $j<$nb_pages; $j++) {?>
				<li><div class="page number-page <?php if( $j == 0 ){echo ' sel';}?>" href="#<?php echo $item_container; ?>" data-jslide="<?php echo $j;?>"><?php echo ($j+1); ?></div></li>
			<?php } ?>
				<li><div class="page page-next" href="#<?php echo $item_container; ?>" data-jslide="next">&raquo;</div></li>
			</ul>
		</div>
		<?php
