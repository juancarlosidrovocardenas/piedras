...
class K2ElementK2Category extends K2Element
{
    ...
    function fetchElement($name, $value, &$node, $control_name)
    {
        ...
        return JHTML::_('select.genericlist', $mitems, $fieldName, $onChange.' class="inputbox" size="1"', 'value', 'text', $value);

    }

}

class JFormFieldSjK2Category extends K2ElementK2Category
{
    var $type = 'sjk2category';
}

class JElementSjK2Category extends K2ElementK2Category
{
    var $_name = 'sjk2category';
}
